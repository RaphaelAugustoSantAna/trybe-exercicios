...
console.log(`Losango com diagonais iguais a 32cm e 18cm: ${Exercise.rhombus(32, 18)}cm²`);
console.log(`Losango com diagonais iguais a 200cm e 50cm: ${Exercise.rhombus(200, 50)}cm²`);
console.log(`Losango com diagonais iguais a 75cm e 25cm: ${Exercise.rhombus(75, 25)}cm²`);
...
console.log(`Área de um círculo de raio igual 25cm: ${Exercise.circle(25)}cm²`);
console.log(`Área de um círculo de raio igual 100cm: ${Exercise.circle(100)}cm²`);
console.log(`Área de um círculo de raio igual 12.5cm: ${Exercise.circle(12.5)}cm²`);
