# funções são definidas através da palavra reservada def,
# seguida por um nome e os parâmetros entre parênteses.
# Como todo bloco de código em Python, o caractere : define o início do bloco,
# e a indentação define seu fim.
...
# Parâmetros posicionais variádicos são acessados como uma
# tupla no interior de uma função, e parâmetros nomeados variádicos como
# um dicionário.
